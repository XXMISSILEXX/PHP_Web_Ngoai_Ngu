                ...
                <div class="table-rating__content">
                    ...
                    ?>
                        <div class="chatbot-content-text">
                            Bạn chưa có phòng chat nào với ChatBot Group 2
                        </div>
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (json.status === "error") {
                                ...
                                appendMessage("assistant", "<?= BASE_URL("assets/img/logo.png") ?>", "Group 2", "", timeResponse, uuid);
                ...
                function getHistoryMessages() {
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            Bạn chưa có tin nhắn nào với ChatBot Group 2
                        ...
                        str += `          <div class="chatbot ${item.Role === "user" ? "right" : "left"}">
                                ...
                                <div class="chatbot-content card">
                                    <div class="chatbot-content-wrap">
                                        <div class="chatbot-name">${item.Role === "user" ? "<?= $getTaiKhoan["TenHienThi"]  ?>"  : "Group 2"}</div>
                ...
                <div class="interact">
                    ...
                    <div class="interact__question-congratulations">
                        ...
                        <div class="interact__question-text">
                            Dùng ChatBot để giải đáp bất kỳ câu hỏi nào, đặc biệt là liên quan đến bài học
                        </div>
